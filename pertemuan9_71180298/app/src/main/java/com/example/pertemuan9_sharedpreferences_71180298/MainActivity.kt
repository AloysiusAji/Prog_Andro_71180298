package com.example.pertemuan9_sharedpreferences_71180298
...
//            val welcomeuser = findViewById<TextView>(R.id.welcomeUser)
            ...
            val adapter = ArrayAdapter.createFromResource(this, R.array.language_option, androidx.appcompat.R.layout.support_simple_spinner_dropdown_item)
            ...
            btnLogin.setOnClickListener {
                if(username.text.toString() == "kira" && password.text.toString() == "freedom123") {
